...
size_t size_function__Auctioninfo__task_list(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<custom_interfaces::msg::Task> *>(untyped_member);
  return member->size();
}

const void * get_const_function__Auctioninfo__task_list(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__Auctioninfo__task_list(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__Auctioninfo__task_list(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const custom_interfaces::msg::Task *>(
    get_const_function__Auctioninfo__task_list(untyped_member, index));
  auto & value = *reinterpret_cast<custom_interfaces::msg::Task *>(untyped_value);
  value = item;
}

void assign_function__Auctioninfo__task_list(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<custom_interfaces::msg::Task *>(
    get_function__Auctioninfo__task_list(untyped_member, index));
  const auto & value = *reinterpret_cast<const custom_interfaces::msg::Task *>(untyped_value);
  item = value;
}

void resize_function__Auctioninfo__task_list(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<custom_interfaces::msg::Task> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Auctioninfo_message_member_array[6] = {
  {
    "agent_id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::Auctioninfo, task_list),  // bytes offset in struct
    nullptr,  // default value
    size_function__Auctioninfo__task_list,  // size() function pointer
    get_const_function__Auctioninfo__task_list,  // get_const(index) function pointer
    get_function__Auctioninfo__task_list,  // get(index) function pointer
    fetch_function__Auctioninfo__task_list,  // fetch(index, &value) function pointer
    assign_function__Auctioninfo__task_list,  // assign(index, value) function pointer
    resize_function__Auctioninfo__task_list  // resize(index) function pointer
  },
  {
    "timestamp",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::Auctioninfo, timestamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
