...
size_t custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__size_function__Auctioninfo__task_list(
  const void * untyped_member)
{
...
const void * custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__get_const_function__Auctioninfo__task_list(
  const void * untyped_member, size_t index)
{
  const custom_interfaces__msg__Task__Sequence * member =
    (const custom_interfaces__msg__Task__Sequence *)(untyped_member);
...
void * custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__get_function__Auctioninfo__task_list(
  void * untyped_member, size_t index)
{
...
void custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__fetch_function__Auctioninfo__task_list(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const custom_interfaces__msg__Task * item =
    ((const custom_interfaces__msg__Task *)
    custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__get_const_function__Auctioninfo__task_list(untyped_member, index));
  custom_interfaces__msg__Task * value =
    (custom_interfaces__msg__Task *)(untyped_value);
  *value = *item;
}

void custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__assign_function__Auctioninfo__task_list(
  void * untyped_member, size_t index, const void * untyped_value)
{
  custom_interfaces__msg__Task * item =
    ((custom_interfaces__msg__Task *)
    custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__get_function__Auctioninfo__task_list(untyped_member, index));
  const custom_interfaces__msg__Task * value =
    (const custom_interfaces__msg__Task *)(untyped_value);
  *item = *value;
}

bool custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__resize_function__Auctioninfo__task_list(
  void * untyped_member, size_t size)
{
  custom_interfaces__msg__Task__Sequence * member =
    (custom_interfaces__msg__Task__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__Auctioninfo_message_member_array[6] = {
  {
    "agent_id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__Auctioninfo, task_list),  // bytes offset in struct
    NULL,  // default value
    custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__size_function__Auctioninfo__task_list,  // size() function pointer
    custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__get_const_function__Auctioninfo__task_list,  // get_const(index) function pointer
    custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__get_function__Auctioninfo__task_list,  // get(index) function pointer
    custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__fetch_function__Auctioninfo__task_list,  // fetch(index, &value) function pointer
    custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__assign_function__Auctioninfo__task_list,  // assign(index, value) function pointer
    custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__resize_function__Auctioninfo__task_list  // resize(index) function pointer
  },
  {
    "timestamp",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__Auctioninfo, timestamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, Auctioninfo)() {
  custom_interfaces__msg__Auctioninfo__rosidl_typesupport_introspection_c__Auctioninfo_message_member_array[4].members_ =
