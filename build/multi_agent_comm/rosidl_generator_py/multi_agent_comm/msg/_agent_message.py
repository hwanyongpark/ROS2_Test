...
class Metaclass_AgentMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('multi_agent_comm')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'multi_agent_comm.msg.AgentMessage')
            logger.debug(
...
class AgentMessage(metaclass=Metaclass_AgentMessage):
    ...
    def __init__(self, **kwargs):
        ...
        self.formatted_time = kwargs.get('formatted_time', str())
    ...
    def __eq__(self, other):
        ...
        if self.timestamp != other.timestamp:
            return False
        if self.formatted_time != other.formatted_time:
            return False
        return True
    ...
    def formatted_time(self):
        """Message field 'formatted_time'."""
        return self._formatted_time

    @formatted_time.setter
    def formatted_time(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'formatted_time' field must be of type 'str'"
        self._formatted_time = value
