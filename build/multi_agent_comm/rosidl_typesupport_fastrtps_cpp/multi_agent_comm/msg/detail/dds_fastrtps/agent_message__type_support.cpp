...
#include "multi_agent_comm/msg/detail/agent_message__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.formatted_time;
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = multi_agent_comm::msg::AgentMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_agent_comm::msg::AgentMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<multi_agent_comm::msg::AgentMessage *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_multi_agent_comm
const rosidl_message_type_support_t *
get_message_type_support_handle<multi_agent_comm::msg::AgentMessage>()
{
  return &multi_agent_comm::msg::typesupport_fastrtps_cpp::_AgentMessage__handle;
}
