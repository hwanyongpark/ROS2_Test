...
bool multi_agent_comm__msg__agent_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("multi_agent_comm.msg._agent_message.AgentMessage", full_classname_dest, 48) == 0);
  }
  multi_agent_comm__msg__AgentMessage * ros_message = _ros_message;
  {  // agent_id
  ...
  {  // formatted_time
    PyObject * field = PyObject_GetAttrString(_pymsg, "formatted_time");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->formatted_time, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
PyObject * multi_agent_comm__msg__agent_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("multi_agent_comm.msg._agent_message");
  ...
  {  // formatted_time
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->formatted_time.data,
      strlen(ros_message->formatted_time.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "formatted_time", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
