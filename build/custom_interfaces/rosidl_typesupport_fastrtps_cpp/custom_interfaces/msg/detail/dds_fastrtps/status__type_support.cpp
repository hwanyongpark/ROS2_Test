...
#include "custom_interfaces/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::Status & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::Status & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, Status)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
