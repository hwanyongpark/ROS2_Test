...
#include "custom_interfaces/msg/detail/task__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.task_position,
    cdr);
  // Member: task_status
  cdr << (ros_message.task_status ? true : false);
  return true;
}
  ...
  custom_interfaces::msg::Task & ros_message)
{
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.task_position);

  // Member: task_status
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.task_status = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ...
    ros_message.task_position, current_alignment);
  // Member: task_status
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::Task;
    is_plain =
      (
      offsetof(DataType, task_status) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::Task *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::Task *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Task__handle;
}
