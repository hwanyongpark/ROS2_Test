...
#ifndef CUSTOM_INTERFACES__SRV__DETAIL__CHECK_NAME__FUNCTIONS_H_
#define CUSTOM_INTERFACES__SRV__DETAIL__CHECK_NAME__FUNCTIONS_H_
...
/// Initialize srv/CheckName message.
/**
...
/// Finalize srv/CheckName message.
/**
...
/// Create srv/CheckName message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__CheckName_Request__init().
...
/// Destroy srv/CheckName message.
/**
 * It calls
 * custom_interfaces__srv__CheckName_Request__fini()
...
/// Check for srv/CheckName message equality.
/**
...
/// Initialize array of srv/CheckName messages.
/**
...
/// Finalize array of srv/CheckName messages.
/**
 * It calls
 * custom_interfaces__srv__CheckName_Request__fini()
...
/// Create array of srv/CheckName messages.
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__CheckName_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CheckName messages.
/**
 * It calls
 * custom_interfaces__srv__CheckName_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CheckName message array equality.
/**
...
/// Copy an array of srv/CheckName messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__CheckName_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__CheckName_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__CheckName_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__CheckName_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_INTERFACES__SRV__DETAIL__CHECK_NAME__FUNCTIONS_H_
