...
{
  new (message_memory) custom_interfaces::msg::Status(_init);
}

void Status_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::Status *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Status_message_member_array[1] = {
  {
    ...
    offsetof(custom_interfaces::msg::Status, num),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Status_message_members = {
  ...
  "Status",  // message name
  1,  // number of fields
  sizeof(custom_interfaces::msg::Status),
...
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, Status)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
