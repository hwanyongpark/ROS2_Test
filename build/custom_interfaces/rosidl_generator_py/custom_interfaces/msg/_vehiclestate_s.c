...
bool custom_interfaces__msg__vehiclestate__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._vehiclestate.Vehiclestate", full_classname_dest, 48) == 0);
  }
  custom_interfaces__msg__Vehiclestate * ros_message = _ros_message;
  {  // name
...
PyObject * custom_interfaces__msg__vehiclestate__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._vehiclestate");
