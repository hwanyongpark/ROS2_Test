...
bool custom_interfaces__msg__tasklist__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._tasklist.Tasklist", full_classname_dest, 40) == 0);
  }
  custom_interfaces__msg__Tasklist * ros_message = _ros_message;
  {  // tasks
    ...
    custom_interfaces__msg__Task * dest = ros_message->tasks.data;
...
PyObject * custom_interfaces__msg__tasklist__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._tasklist");
