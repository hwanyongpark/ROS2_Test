...
#include "custom_interfaces/msg/detail/vehiclestate__rosidl_typesupport_fastrtps_c.h"
...
using _Vehiclestate__ros_msg_type = custom_interfaces__msg__Vehiclestate;
...
size_t get_serialized_size_custom_interfaces__msg__Vehiclestate(
  const void * untyped_ros_message,
...
static uint32_t _Vehiclestate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__Vehiclestate(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__Vehiclestate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__Vehiclestate;
    is_plain =
      (
...
static size_t _Vehiclestate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__Vehiclestate(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, Vehiclestate)() {
